<template>
    <div id="wrapper" class="full">
        <div id="content" class="max">
            <div class="lists" style="width: 95%; margin: auto;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="padding: 35px 20px">
                        <p class="post-title">
                            <span>Thành Phố Đà Nẵng {{$route.params.titleBlog}}</span>
                        </p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <a href="#">
                                <img class="thumbnail-img-post img-responsive" src="#" alt="Image">
                            </a>
                    </div>
...
<script>
// console.log(this.$route.params.titleBlog)
export default {
    name: 'DetailBlog',
    data: ()=> {
        return {
            // test: this.$route.params.titleBlog
        };
    }
}
</script>
