<template>
  <div class="wrapper">
        <div class="lists" style="width: 85%; margin: auto;">
                ...
                <div class="col-xs-10 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div class="post-content" v-html="blog.content">
                        ...
                        <div class="image-block">
                            ...
                            <div class="ib-title"><span class="osLight">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit</span></div>
                        </div>
                        <h2 class="osLight">The standard chunk of Lorem Ipsum used</h2>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                        <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p> -->
                    </div>
                    <div class="fb-comments" :data-href="`https://localhost:8080/nhan-dinh/${blog.headerBlog}`" data-width="100%" data-numposts="10"></div>

                </div>
                
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <img class="thumbnail-img-post img-responsive" src="https://images.kienthuc.net.vn/zoomh/500/uploaded/nguyenanhson/2019_05_11/3/chang-trai-gay-sot-vi-gia-gai-xinh-nhu-tien-khien-bao-anh-chang-say-dam.jpg" alt="Image">
                </div>
